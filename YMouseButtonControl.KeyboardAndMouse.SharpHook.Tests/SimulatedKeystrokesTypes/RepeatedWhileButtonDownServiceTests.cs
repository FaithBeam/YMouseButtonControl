...
public class RepeatedWhileButtonDownServiceTests
{
    ...
    public void RepeatWhileDown()
    {
        ...
        var sut = new RepeatedWhileButtonDownService(sksM);
        
        sut.RepeatWhileDown(mapping, MouseButtonState.Pressed);
        // Need to wait for the thread to send keys. Is there a better way to do this?
        Thread.Sleep(50);
        sut.RepeatWhileDown(mapping, MouseButtonState.Released);
