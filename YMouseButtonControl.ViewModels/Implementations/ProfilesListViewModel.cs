...
public class ProfilesListViewModel : ViewModelBase, IProfilesListViewModel
{
    ...
    public Interaction<IProcessSelectorDialogViewModel, Profile> ShowProcessSelectorInteraction { get; }

    public ProfilesListViewModel(IProfilesService profilesService, IProcessSelectorDialogViewModel processSelectorDialogViewModel)
    {
        ...
        ShowProcessSelectorInteraction = new Interaction<IProcessSelectorDialogViewModel, Profile>();
