...
public static partial class ProfileMapper
{
    ...
    public static partial IEnumerable<ProfileVm> Map(IEnumerable<Profile> profiles);

    public static partial IEnumerable<Profile> Map(IEnumerable<ProfileVm> profiles);
