...
/// <summary>
/// This class handles a Windows low level mouse hook that monitors mouse button presses and optionally blocks the mouse
/// button event from reaching the target application. This sets a hook globally so it is not per application.
/// </summary>
